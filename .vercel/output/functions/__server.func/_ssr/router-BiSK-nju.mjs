...
import { n as auth } from "./server-0359soIZ.mjs";
import { t as TriangleAlert } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BiSK-nju.js
...
var styles_default = "/assets/styles-DHtQ77Yc.css";
...
var Route$8 = createRootRoute({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "SafeLearn — practical ArcGIS and disaster-management tutorials for UENR students. One-time GHS 50 access."
			},
			{
				name: "theme-color",
				content: "#2C5D4E"
...
var $$splitComponentImporter$6 = () => import("./routes-CPveFHff.mjs");
var Route$7 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./admin-C0ibVa0e.mjs");
var Route$6 = createFileRoute("/admin")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./dashboard-C9CgWmJm.mjs");
var Route$5 = createFileRoute("/dashboard")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./login-BLDJDgzr.mjs");
var Route$4 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./courses-Bvt2WveI.mjs");
var Route$3 = createFileRoute("/courses/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("../_slug-96XMEPsf.mjs");
var Route$2 = createFileRoute("/courses/$slug")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var Route$1 = createFileRoute("/api/auth/$")({ server: { handlers: {
	GET: ({ request }) => auth.handler(request),
	POST: ({ request }) => auth.handler(request)
} } });
var $$splitComponentImporter = () => import("../_lessonId-3MlnUX-T.mjs");
var Route = createFileRoute("/learn/$slug/$lessonId")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
...
var rootRouteChildren = {
	...
	DashboardRoute,
	LoginRoute,
	CoursesSlugRoute: Route$2.update({
		id: "/courses/$slug",
		path: "/courses/$slug",
		getParentRoute: () => Route$8
	}),
	...
	LearnSlugLessonIdRoute: Route.update({
...
//#endregion
export { PAYMENT as a, createSsrRpc as c, APP_NAME as i, Route as n, SUPPORT as o, Route$2 as r, formatGhs as s, router_exports as t };
